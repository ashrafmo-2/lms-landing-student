            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-xl border border-[#e2e8f0] p-8 text-center">
                    ...
                    <button
                        ...
                        className="w-full bg-[#6c3aff] hover:bg-[#5228e8] text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-[#6c3aff]/30"
                    >
                        تسجيل الدخول
                    </button>
                </div>
                    ...
                    <>
                        <div className="text-center mb-6">
                            ...
                            <p className="text-sm text-[#64748b]">
                                ادخل بريدك الإلكتروني وهنبعتلك كود التحقق.
                            </p>
                        </div>
                            ...
                            <button
                                onClick={async () => {
                                    try {
                                        ...
                                        setOtpError("فشل إعادة الإرسال، حاول مرة أخرى");
                                    }
                                }}
