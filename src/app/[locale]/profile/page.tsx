    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 gap-4 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          سيتم تسجيل خروجك وإعادة توجيهك لتسجيل الدخول...
        </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-md">
      ...
      <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl p-4">
        ...
        <p className="text-sm text-amber-700">
          بعد تغيير كلمة المرور سيتم تسجيل خروجك من جميع الأجهزة تلقائياً.
        </p>
      </div>
      ...
      <div>
        ...
        >
          <span className="flex items-center gap-1.5">
            <Lock className="w-4 h-4" /> كلمة المرور الحالية
          </span>
        </label>
      ...
      <div>
        ...
        <div className="flex gap-3 mt-2">
          {[
            ...
            <span
              key={label}
              className={`text-xs font-medium flex items-center gap-1 ${ok ? "text-green-600" : "text-muted-foreground"}`}
            >
              <Check
      ...
      <div>
        ...
        >
          <span className="flex items-center gap-1.5">
            <Lock className="w-4 h-4" /> تأكيد كلمة المرور
          </span>
        </label>
        <div className="relative">
          <input
      ...
      >
        {saving ? (
          ...
          <>
            <ShieldCheck className="w-4 h-4" /> تغيير كلمة المرور
          </>
        )}
      </button>
    </form>
        ...
        <div className="flex flex-wrap gap-3">
          {ACCENT_COLORS.map((color) => {
            ...
            return (
              ...
              >
                <span
                  className={`w-5 h-5 rounded-full ${color.preview} shadow-sm flex items-center justify-center`}
                >
      ...
      <div>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-4 shadow-sm">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="px-4 py-2 bg-muted text-foreground text-xs font-bold rounded-lg border border-border"
            >
              {t("secondaryButton")}
            </button>
          </div>
      ...
      <main className="min-h-screen flex flex-col bg-background">
        ...
        <div className="flex-1 pt-24 pb-16 bg-muted">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Tabs */}
            <div
              className="flex gap-1 bg-card border border-border p-1 rounded-xl mb-6 w-fit shadow-sm"
              dir="rtl"
            >
