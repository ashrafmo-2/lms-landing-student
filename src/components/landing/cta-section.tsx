...
export function CTASection() {
    return (
        <section className="py-24 bg-gradient-to-br from-[#6c3aff] to-[#5228e8] relative overflow-hidden" dir="rtl">
            {/* Background pattern */}
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                    التعلم مش مجرد فيديوهات، تفاعل مع المحتوى، حل الـ Quizzes، واجمع نقاط عشان اسمك يظهر في المركز الأول لزمايلك!
                </p>
                <Link
                    href="/auth/signup"
